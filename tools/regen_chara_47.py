...
TARGET = BASE_DIR / 'img/Chapter8/chara/image_merge_order_chara_47.png'
...
CHAR_PROMPT = (
    f"{CHAR_STYLE}, "
    "young Japanese man, 26 years old, black slicked-back hair, slim build, "
    "sharp and calculating eyes, confident and cold expression, "
    "fitted dark suit with navy tie, ambitious talent manager personality, "
    "stylish and businesslike appearance"
)
