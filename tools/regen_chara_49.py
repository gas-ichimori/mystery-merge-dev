...
TARGET = BASE_DIR / 'img/Chapter8/chara/image_merge_order_chara_49.png'
...
CHAR_PROMPT = (
    f"{CHAR_STYLE}, "
    "young Japanese woman, 24 years old, black hair with pink inner color highlights, "
    "bold glamorous makeup with false lashes, confident and provocative expression, "
    "trendy revealing stylish outfit, popular VTuber streamer personality, "
    "outwardly friendly but secretly jealous and cunning"
)
