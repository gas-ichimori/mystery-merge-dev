#!/usr/bin/env python3
"""謎のユーザー774（chara_50）の画像を再生成するスクリプト"""
...
TARGET = BASE_DIR / 'img/Chapter8/chara/image_merge_order_chara_50.png'
...
CHAR_PROMPT = (
    f"{CHAR_STYLE}, "
    "Japanese man, estimated 30s, slightly overweight chubby build, short dark hair, "
    "thick-framed glasses, plain checked flannel shirt, nervous and frightened expression, "
    "anonymous internet user appearance, disheveled and unkempt look, "
    "timid and evasive personality"
)
